...
var entityManager GormEntityManager

// GormEntityManager is a container struct that holds the
...
// API and Core
func GetEntityManager() *GormEntityManager {
...
func Init(db *gorm.DB) error {
	entityManager = GormEntityManager{
		db,
...
// RegisterEntity registers a new entity (struct) and runs its automated
// migration to ensure the database schema is up-to-date.
func (em *GormEntityManager) RegisterEntity(entityType interface{}) error {
...
//
// Returns an error if no record could be found.
func (em *GormEntityManager) GetFirstEntity(entityContainer interface{}, conditions ...interface{}) error {
...
//
// Returns false if no entries could be found.
func (em *GormEntityManager) GetLastEntity(entityContainer interface{}, conditions ...interface{}) error {
...
// Create creates the passed entity in the database
func (em *GormEntityManager) Create(entity interface{}) error {
	return em.database.Create(entity).Error
}

// Save upserts the passed entity in the database
func (em *GormEntityManager) Save(entity interface{}) error {
	return em.database.Save(entity).Error
}

// UpdateEntity can be used to update the passed entity in the database
func (em *GormEntityManager) UpdateEntity(entityContainer interface{}, column string, value interface{}) error {
...
func (em *GormEntityManager) DeleteEntity(entityContainer interface{}) error {
...
// already prepared to get started with applying filters.
// This function is the only interface point to get direct access to gorm.DB
func (em *GormEntityManager) WorkOn(entityContainer interface{}) *gorm.DB {
